    ...
    <div className="min-h-screen bg-white py-10 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex flex-col items-center mb-8">
          <div
            className="w-24 h-24 rounded-full bg-[#f3f4f6] border-2 border-[#e5e7eb] flex items-center justify-center text-3xl font-medium text-[#374151] mb-3 overflow-hidden cursor-pointer hover:opacity-80 transition"
          ...
          <button
            ...
            onClick={handlePhotoClick}
            disabled={uploading}
            className="text-sm text-[#6b7280] hover:text-[#111827] underline underline-offset-2 transition disabled:opacity-50"
          >
        ...
        <button
          ...
          onClick={handleSave}
          disabled={saving}
          className="w-full bg-[#111827] text-white rounded-full py-3 text-sm font-medium hover:bg-[#374151] transition disabled:opacity-60"
        >
