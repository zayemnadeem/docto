    ...
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="max-w-3xl mx-auto text-center">
          <h1
            className="text-4xl md:text-5xl text-[#0d2b28] leading-tight tracking-tight"
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
          ...
          {PLANS.map(plan => (
            <div
              ...
              className={`relative flex flex-col rounded-2xl p-6 border transition-all duration-300 ${
                plan.popular
                  ? 'border-[#1a9e8f] shadow-lg xl:-translate-y-4 bg-white z-10'
                  : 'border-[#e5e7eb] hover:border-[#1a9e8f] hover:shadow-md bg-white'
              }`}
            >
              {plan.popular && (
                <span className="absolute -top-3 left-1/2 -translate-x-1/2 text-xs font-semibold px-4 py-1 rounded-full bg-[#1a9e8f] text-white whitespace-nowrap tracking-wide">
                  MOST POPULAR
                </span>
              )}
              ...
              <div className="mb-6 flex-grow">
                ...
                <h3 className="text-2xl text-[#0d2b28] mt-1 mb-3">
                  {plan.name}
                </h3>
                <div className="flex items-baseline gap-1">
                  <span className="text-4xl font-semibold text-[#0d2b28]">&#8377;{plan.price}</span>
              ...
              <Link
                ...
                className={`w-full rounded-full py-3 text-sm font-medium transition text-center ${
                  ...
                  : 'bg-[#e6f7f5] text-[#1a9e8f] hover:bg-[#c8ede9] border border-[#c8e8e5]'
                }`}
              >
                Get Started
              </Link>
        ...
        <div className="mt-20 max-w-2xl mx-auto text-center space-y-4">
          <h3 className="text-2xl text-[#0d2b28]">Frequently Asked Questions</h3>
          <div className="bg-[#f8f9fb] rounded-2xl p-6 border border-[#e5e7eb] text-left">
            <h4 className="font-medium text-[#0d2b28]">Can I upgrade or downgrade anytime?</h4>
            <p className="text-sm text-[#6b7280] mt-1 mb-4">Yes, your plan will be seamlessly prorated for upgrades.</p>
            
            <h4 className="font-medium text-[#0d2b28]">Is there a completely free plan?</h4>
