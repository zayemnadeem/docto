        ...
        <div className="flex-grow min-w-0">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {['annual', 'quarterly', 'enterprise'].includes(doctor.subscription_plan) && (
              <span className="flex-shrink-0 inline-flex items-center gap-0.5 px-2 py-0.5 rounded-full bg-gradient-to-r from-amber-400 to-amber-500 text-white text-[10px] font-bold tracking-wider shadow-sm" title="Premium Plan">
